...
I was talking with a designer on my team who had been sitting with the same frustration. The design world had been shifting fast, from design tools to vibe-coded prototypes and back again, and somewhere in that back-and-forth was the same unanswered question: why can't we just describe a UI and have it work everywhere? His hunch and mine were the same thing said from different chairs.

He showed me [JSON render](https://json-render.dev/), a way to describe a component's structure as data and render. Just the description, traveling to wherever it needed to go.

That clicked for me, but I wanted to take it further. Not just structure, behavior and styles too. The whole design system, described once, portable everywhere. That's what was missing.
